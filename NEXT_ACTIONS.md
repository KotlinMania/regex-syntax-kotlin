...
- **Function parity:** 476/758 matched (target 746) — 62.8%
- **Class/type parity:** 113/134 matched (target 267) — 84.3%
- **Combined symbol parity:** 589/892 matched (target 1013) — 66.0%
- **Average inline-code cosine:** 0.83 (function body across 29 matched files)
...
### 5. unicode_tables.property_names
...
- **Similarity:** 0.52
- **Dependents:** 0
- **Priority Score:** 433304.8
- **Functions:** 83/122 matched (target 106)
- **Missing functions:** `eq`, `s`, `parser_octal`, `parser_empty_min_range`, `parser_nest_limit`, `parser_ignore_whitespace`, `nspan`, `npos`, `span_range`, `lit`, `meta_lit`, `lit_with`, `concat`, `concat_with`, `alt`, `group`, `flag_set`, `parse_comments`, `parse_ignore_whitespace`, `parse_alternate`, `parse_unsupported_lookaround`, `parse_primitive_non_escape`, `parse_unsupported_backreference`, `parse_hex_two`, `parse_hex_four`, `parse_hex_eight`, `union`, `intersection`, `difference`, `symdifference`, `itemset`, `item_ascii`, `item_unicode`, `item_perl`, `item_bracket`, `empty`, `range`, `alnum`, `lower`
...
- **Target:** `commonMain.kotlin.io.github.kotlinmania.regexsyntax.ast.print.Print [PROVENANCE-FALLBACK]`
- **Similarity:** 0.77
- **Dependents:** 0
...
- **Functions:** 20/23 matched (target 41)
...
- **Provenance warning:** port-lint provenance header matched only after fallback normalization: `tests:src/ast/mod.rs` vs expected `ast/mod.rs`
- **Proposed provenance header:** `// port-lint: source ast/mod.rs` (current: `// port-lint: source src/ast/mod.rs`)
- **Proposed provenance header:** `// port-lint: tests ast/mod.rs` (current: `// port-lint: tests src/ast/mod.rs`)
- **Lint issues:** 2
...
- **Target:** `regexsyntax.MetaCharacter`
- **Similarity:** 0.51
- **Dependents:** 0
- **Priority Score:** 21204.9
- **Functions:** 10/12 matched (target 10)
- **Missing functions:** `word_char_disabled_panic`, `word_char_disabled_error`
...
### 21. unicode_tables.general_category
...
### 22. unicode_tables.grapheme_cluster_break
...
### 23. unicode_tables.case_folding_simple
...
### 24. unicode_tables.script_extension
...
### 25. unicode_tables.sentence_break
...
### 27. unicode_tables.perl_decimal
...
./ast_distance --init-tasks ../../tmp/regex-syntax/src rust ../../src/commonMain/kotlin kotlin tasks.json ../../AGENTS.md
