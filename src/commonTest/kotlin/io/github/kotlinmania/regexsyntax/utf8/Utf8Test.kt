...
class Utf8Test {
    ...
    fun bmp() {
        ...
        assertEquals(
            listOf(
                ...
                Utf8Sequence.Two(arrayOf(rutf8(0xC2, 0xDF), rutf8(0x80, 0xBF))),
                Utf8Sequence.Three(arrayOf(rutf8(0xE0, 0xE0), rutf8(0xA0, 0xBF), rutf8(0x80, 0xBF))),
                Utf8Sequence.Three(arrayOf(rutf8(0xE1, 0xEC), rutf8(0x80, 0xBF), rutf8(0x80, 0xBF))),
                Utf8Sequence.Three(arrayOf(rutf8(0xED, 0xED), rutf8(0x80, 0x9F), rutf8(0x80, 0xBF))),
                Utf8Sequence.Three(arrayOf(rutf8(0xEE, 0xEF), rutf8(0x80, 0xBF), rutf8(0x80, 0xBF))),
            ),
            seqs,
        )
    }
    ...
    fun reverse() {
        ...
        s = Utf8Sequence.Two(arrayOf(rutf8(0xA, 0xB), rutf8(0xB, 0xC)))
        s = s.reverse()
        assertEquals(listOf(rutf8(0xB, 0xC), rutf8(0xA, 0xB)), s.asSlice())

        s = Utf8Sequence.Three(arrayOf(rutf8(0xA, 0xB), rutf8(0xB, 0xC), rutf8(0xC, 0xD)))
        s = s.reverse()
        assertEquals(listOf(rutf8(0xC, 0xD), rutf8(0xB, 0xC), rutf8(0xA, 0xB)), s.asSlice())

        s = Utf8Sequence.Four(arrayOf(rutf8(0xA, 0xB), rutf8(0xB, 0xC), rutf8(0xC, 0xD), rutf8(0xD, 0xE)))
        s = s.reverse()
