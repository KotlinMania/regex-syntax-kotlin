# Agent guide - regex-syntax-kotlin

This file is the quick-reference operating contract for regex-syntax-kotlin. The longer
...
regex-syntax-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`regex-syntax`](./README.md). Upstream Rust is the behavioral oracle while the
