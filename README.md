...
[![GitHub link](https://img.shields.io/badge/GitHub-KotlinMania%2Fregex--syntax--kotlin-blue.svg)](https://github.com/KotlinMania/regex-syntax-kotlin)
[![Maven Central](https://img.shields.io/maven-central/v/io.github.kotlinmania/regex-syntax)](https://central.sonatype.com/artifact/io.github.kotlinmania/regex-syntax)
[![Build status](https://img.shields.io/github/actions/workflow/status/KotlinMania/regex-syntax-kotlin/ci.yml?branch=main)](https://github.com/KotlinMania/regex-syntax-kotlin/actions)

This is a Kotlin Multiplatform line-by-line transliteration port of [`rust-lang/regex`](https://github.com/rust-lang/regex).

**Original Project:** This port is based on [`rust-lang/regex`](https://github.com/rust-lang/regex). All design credit and project intent belong to the upstream authors; this repository is a faithful port to Kotlin Multiplatform with no behavioural changes intended.
...
> The text below is reproduced and lightly edited from [`https://github.com/rust-lang/regex`](https://github.com/rust-lang/regex). It is the upstream project's own description and remains under the upstream authors' authorship; links have been rewritten to absolute upstream URLs so they continue to resolve from this repository.
...
The [`regex-automata` directory](https://github.com/rust-lang/regex/blob/HEAD/regex-automata/) contains a crate that
 ...
 * Apache License, Version 2.0, ([LICENSE-APACHE](https://github.com/rust-lang/regex/blob/HEAD/LICENSE-APACHE) or
   https://www.apache.org/licenses/LICENSE-2.0)
 * MIT license ([LICENSE-MIT](https://github.com/rust-lang/regex/blob/HEAD/LICENSE-MIT) or
...
This Kotlin port is distributed under the same MIT license as the upstream [`rust-lang/regex`](https://github.com/rust-lang/regex). See [LICENSE](LICENSE) (and any sibling `LICENSE-*` / `NOTICE` files mirrored from upstream) for the full text.
...
Thanks to the [`rust-lang/regex`](https://github.com/rust-lang/regex) maintainers and contributors for the original Rust implementation. This port reproduces their work in Kotlin Multiplatform; bug reports about upstream design or behavior should go to the upstream repository.
