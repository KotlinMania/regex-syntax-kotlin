...
kotlin {
    ...
    val xcf = XCFramework("RegexSyntax")

    macosArm64 {
        binaries.framework { baseName = "RegexSyntax"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "RegexSyntax"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "RegexSyntax"
        flattenPackage = "io.github.kotlinmania.regexsyntax"
    }

    android {
        namespace = "io.github.kotlinmania.regexsyntax"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "regex-syntax-kotlin", version.toString())

    pom {
        name.set("regex-syntax-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/regex-syntax-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/regex-syntax-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/regex-syntax-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/regexsyntax/codeql/CodeqlEmptySource.kt",
            )
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.regexsyntax.codeql

                private object CodeqlEmptySource
                """.trimIndent(),
            )
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleRegexSyntaxXCFramework",
)
